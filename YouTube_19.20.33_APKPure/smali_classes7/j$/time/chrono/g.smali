...
.method static R(Lj$/time/chrono/n;Lj$/time/temporal/Temporal;)Lj$/time/chrono/g;
    .locals 3
...
.method static S(Lj$/time/chrono/b;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    .locals 1
...
.method private V(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    ...
    invoke-direct {v0, v1, v6}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
...
.method private Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    .locals 2
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/d;->R(Lj$/time/chrono/n;Lj$/time/temporal/Temporal;)Lj$/time/chrono/b;
...
.method public final F(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    ...
    .line 16
    .line 17
    invoke-virtual {p0}, Lj$/time/chrono/g;->b()Lj$/time/LocalTime;
...
.method public final T(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/g;
    .locals 21
    ...
    .line 23
    .line 24
    iget-object v3, v10, Lj$/time/chrono/g;->b:Lj$/time/LocalTime;
    ...
    .line 33
    invoke-direct {v10, v0, v3}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    ...
    .line 48
    invoke-direct {v10, v2, v3}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    ...
    .line 208
    invoke-static {v1, v0}, Lj$/time/chrono/g;->R(Lj$/time/chrono/n;Lj$/time/temporal/Temporal;)Lj$/time/chrono/g;
...
.method public final W(Lj$/time/ZoneOffset;)Lj$/time/Instant;
    .locals 4
    ...
    .line 5
    iget-object p1, p0, Lj$/time/chrono/g;->b:Lj$/time/LocalTime;
...
.method public final X(JLj$/time/temporal/o;)Lj$/time/chrono/g;
    .locals 3
    ...
    .line 17
    .line 18
    invoke-virtual {v2, p1, p2, p3}, Lj$/time/LocalTime;->k0(JLj$/time/temporal/o;)Lj$/time/LocalTime;
    ...
    .line 22
    invoke-direct {p0, v1, p1}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    ...
    .line 27
    :cond_0
    invoke-interface {v1, p1, p2, p3}, Lj$/time/chrono/b;->d(JLj$/time/temporal/o;)Lj$/time/chrono/b;
    ...
    .line 31
    invoke-direct {p0, p1, v2}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
    ...
    .line 44
    invoke-static {v0, p1}, Lj$/time/chrono/g;->R(Lj$/time/chrono/n;Lj$/time/temporal/Temporal;)Lj$/time/chrono/g;
...
.method public final bridge synthetic d(JLj$/time/temporal/o;)Lj$/time/temporal/Temporal;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/g;->X(JLj$/time/temporal/o;)Lj$/time/chrono/g;
...
.method public final bridge synthetic e(JLj$/time/temporal/TemporalUnit;)Lj$/time/temporal/Temporal;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/g;->T(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/g;
...
.method public final f(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    .line 12
    invoke-interface {v1, p1}, Lj$/time/chrono/n;->D(Lj$/time/temporal/Temporal;)Lj$/time/chrono/e;
    ...
    .line 34
    :goto_0
    iget-object v3, p0, Lj$/time/chrono/g;->b:Lj$/time/LocalTime;
    ...
    .line 39
    .line 40
    invoke-interface {p1, v1}, Lj$/time/temporal/l;->w(Lj$/time/temporal/o;)J
    ...
    .line 44
    invoke-interface {v0, v1}, Lj$/time/temporal/l;->w(Lj$/time/temporal/o;)J
    ...
    .line 66
    invoke-static {v4, v5, v0, v1}, Lj$/lang/a;->f(JJ)J
    ...
    .line 124
    invoke-static {v4, v5, p1, p2}, Lj$/lang/a;->c(JJ)J
...
.method public final n(Lj$/time/temporal/o;)I
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/l;->n(Lj$/time/temporal/o;)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/g;->r(Lj$/time/temporal/o;)Lj$/time/temporal/s;

    move-result-object v0

    invoke-virtual {p0, p1}, Lj$/time/chrono/g;->w(Lj$/time/temporal/o;)J
...
.method public final q(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    ...
    .line 6
    .line 7
    invoke-direct {p0, p1, v0}, Lj$/time/chrono/g;->Y(Lj$/time/temporal/Temporal;Lj$/time/LocalTime;)Lj$/time/chrono/g;
...
.method public final s(Lj$/time/ZoneOffset;)Lj$/time/chrono/k;
    ...
    .line 2
    invoke-static {p1, v0, p0}, Lj$/time/chrono/m;->R(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/k;
